...
$ventas = $transaccionDAO->obtenerVentasDetalladasVendedor($idVendedor, $idCategoriaFiltro, $fechaDesde, $fechaHasta);

if ($ventas !== null) {
    echo json_encode(['success' => true, 'ventas' => $ventas]);
} else {
    echo json_encode(['success' => false, 'ventas' => [], 'message' => 'Error al obtener las ventas detalladas.']);
}
