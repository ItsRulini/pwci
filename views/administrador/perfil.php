...
<body>
    ...
    <div class="pubs-content">
        <section class="pubsection">
            <h2 class="section-title">Productos Aprobados por mí</h2>
            <div class="card-container" id="aprobadosContainerAdmin">
                <!-- {/* */} -->
                 <div class="no-products-message">Cargando...</div>
            </div>
        </section>

        <section class="pubsection">
            <h2 class="section-title">Productos Rechazados por mí</h2>
            <div class="card-container" id="rechazadosContainerAdmin">
                <!-- {/* */} -->
                 <div class="no-products-message">Cargando...</div>
            </div>
        </section>
